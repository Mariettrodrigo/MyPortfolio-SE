...
const Header = ({isDarkMode}) => {
  return (
    <div className='w-11/12 max-w-2xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
      ...
      className='flex items-end gap-2 text-xl md:text-2xl mb-1 font-ovo'>Hi! I'm Mariyeta Rodrigo</motion.h3>
      <motion.h1 
      initial={{y: -30, opacity:0}}
      whileInView={{y:0, opacity:1}}
      transition={{duration: 0.8, delay:0.5}}
      className='text-3xl sm:text-6xl lg:text-[73px] font-ovo'>Software Developer</motion.h1>
      ...
      className='max-w-2xl mx-auto font-ovo leading-tight'>
       A detail-oriented developer with a passion for building intuitive interfaces and transforming ideas into functional, polished digital experiences.
      </motion.p>
